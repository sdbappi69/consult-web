...
function connectToConference(vidyoConnector) {
    ...
    if ( $("meta[name=resourceId]").attr('content').indexOf(" ") != -1 || $("meta[name=resourceId]").attr('content').indexOf("@") != -1) {
    ...
    console.log('Data:',$("meta[name=video_token]").attr('content'),$("meta[name=displayName]").attr('content'),$("meta[name=resourceId]").attr('content'))
    vidyoConnector.Connect({
        // Take input from options form
        host: "prod.vidyo.io",
        token:$("meta[name=video_token]").attr('content'),
        displayName: $("meta[name=displayName]").attr('content'),
        resourceId: $("meta[name=resourceId]").attr('content'),
